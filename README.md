...
Приложение связывается с умными замками через Bluetooth Low Energy (BLE). С устройством BLE можно общаться через т.н. "Сервисы" - через чтение и запись "Характеристик" этих Сервисов.
