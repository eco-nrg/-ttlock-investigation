...
* Код: `0x45`
* Параметры: `нет`
* Пример команды: `[0x7f,0x5a,0x05,0x03,0x01,0x00,0x01,0x00,0x01,0x45,0xaa,0x00,0xb3,0x0d,0x0a]`
...
* Пример комадны: `[0x7f,0x5a,0x05,0x03,0x01,0x00,0x01,0x00,0x01,0x19,0xaa,0x10,0x26,0xed,0x1d,0x92,0x58,0xa1,0xe4,0x28,0xfc,0xb4,0x8b,0xbd,0x1c,0x0e,0x5a,0x46,0xbc,0x0d,0x0a]`
...
Здесь:
* `0x19` - код команды
* `0x01` - статус команды (успех)
* `[0xc0,0x15,0x7a,0x26,0x89,0x3a,0xde,0x25,0xc8,0xc4,0x71,0x7e,0xb8,0xdf,0x0b,0x84]` - новый сеансовый ключ, которым мы будем пользоваться для шифрования и расшифрования всех последующих сообщений.
